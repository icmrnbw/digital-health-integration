CodeSystem: Form096MaternalPelvimetryMeasurementCodeCS
...
* #chr-0083-0001 "Distantia spinarum — chanoqning o‘simtalararo o‘lchami"
...
* #chr-0083-0002 "Distantia cristarum — chanoq qirralari orasidagi o‘lcham"
  * ^designation[0].language = #en
...
* #chr-0083-0003 "Distantia trochanterica — katta ko‘stlar orasidagi o‘lcham"
  * ^designation[0].language = #en
...
* #chr-0083-0004 "Conjugata externa — tashqi konyugata"
  * ^designation[0].language = #en
...
* #chr-0083-0005 "Conjugata diagonalis — diagonal konyugata"
  * ^designation[0].language = #en
...
* #chr-0083-0006 "Conjugata vera — haqiqiy konyugata"
  * ^designation[0].language = #en
