...
- **Education level numbering**: this IG's `chr-0010-00001` = "Higher education" / `chr-0010-00002` = "Secondary general education" (internally consistent — the example's `chr-0010-00002` "O'rta umumiy ta'lim" correctly matches this IG's own CodeSystem). The DMED review's numbering is reversed (`chr-0010-00001` = elementary, `chr-0010-00002` = higher). Same "different numbering scheme" situation as above.
